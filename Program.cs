...
namespace Samples
{
    public class Sample
    {
        ...
        private static void testIBMethods(EWrapperImpl wrapper)
        {
            ...
            //orderInfo.OrderId = wrapper.NextOrderId++;
            ...
            //// orderInfo  - An object specifying the order type, quantity, side and other order parameters
            //wrapper.ClientSocket.placeOrder(orderInfo.OrderId, contract, orderInfo);
            
            //Console.WriteLine("Ready to cancel order. Press a Key.");
            //Console.ReadKey();
            //// Cancel the order 
            
            //wrapper.ClientSocket.cancelOrder(orderInfo.OrderId);
